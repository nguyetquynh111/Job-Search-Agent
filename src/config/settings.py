"""Runtime configuration and production preflight checks for core code."""
...
DEFAULT_JOBS_PATH = Path("data/jobs.csv")
DEFAULT_PROFILE_PATH = Path("data/preferences.yaml")
DEFAULT_RESUME_PATH = Path("data/resume.tex")
DEFAULT_PORTFOLIO_PATH = Path("data/portfolio.txt")
