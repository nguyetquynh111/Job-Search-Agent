"""Job posting contracts and experience normalization."""
...
from src.domain.base import StrictBaseModel, normalize_string_list
...
class ExperienceRequirement(StrictBaseModel):
    ...
    @classmethod
    def blank_raw_text(_cls, value: Any) -> Any:
...
class Job(StrictBaseModel):
    ...
    @classmethod
    def normalize_legacy_fields(_cls, value: Any) -> Any:
    ...
    @classmethod
    def reject_blank_required_text(_cls, value: str, info: Any) -> str:
        if not value:
    ...
    @classmethod
    def normalize_optional_display_text(_cls, value: Any) -> str:
        if value is None:
            return ""
    ...
    @classmethod
    def normalize_source(_cls, value: Any) -> Any:
        if isinstance(value, str):
            stripped = value.strip()
            return stripped or None
        return value
    ...
    @classmethod
    def normalize_skills(_cls, value: Any) -> list[str]:
