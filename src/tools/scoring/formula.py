...
A model never generates the number; this is plain arithmetic
over a :class:`~src.tools.scoring.profile_index.CandidateIndex`.
...
from src.tools.filtering.rules import is_remote_eligible
from src.tools.fit_analysis.aliases import canonicalize
from src.tools.scoring.profile_index import CandidateIndex
