        ...
        *,
        ...
        if self.enabled and self.client is not None:
            try:
                ...
                if hasattr(root_client, "get_trace_url"):
                    self.trace_url = root_client.get_trace_url()
                else:
                    self.trace_url = getattr(root_client, "url", None)
            except Exception:
        ...
        *,
        ...
        if self.enabled and self.client is not None:
            try:
                ...
                self._root_client = root_client
                if not self.trace_url and hasattr(root_client, "get_trace_url"):
                    self.trace_url = root_client.get_trace_url()
            except Exception:
                self._disable_remote_tracing(
